...
describe('Parsing', () => {
    ...
    it("Parse Default Hour-Degree Patterns", () => {
        for (let i = 0, l = samples.length; i < l; i++) {
            ...
            expect(expected.declination.degreeMilliseconds).toBeCloseTo(actual.declination.degreeMilliseconds, 0.5); //, "Failed at: " + i
            expect(expected.rightAscension.degreeMilliseconds).toBeCloseTo(actual.rightAscension.degreeMilliseconds, 0.5); //, "Failed at: " + i
        }
    });
});
