...
d.parse=function(a,e,f){return d.matchToAngle(d.match(a,e,f))};d.match=function(a,e,f){null!=a&&(a=a.trim().replace(/^[^(0-9|a-zA-Z|\-)]/,""));for(var h=null,k=0;k<d.RegexPatterns.length;k++){var b=(new RegExp(d.RegexPatterns[k],"g")).exec(a);if(null!=b){void 0===f&&(a=e[k],f=void 0!==a?a:d.RegexPatternStyleMap[k]);h={match:b,style:f};break}}if(null==h)throw"s";return h};d.matchToAngle=function(d){var e=d.match[2];e&&(e=e.replace(",","."));var h=parseFloat(e);isNaN(h)&&(h=0);(e=d.match[4])&&(e=e.replace(",",
"."));var k=parseFloat(e);isNaN(k)&&(k=0);(e=d.match[6])&&(e=e.replace(",","."));e=parseFloat(e);isNaN(e)&&(e=0);switch(d.style){case f.Hour:h=a.fromHours(h,k,e);break;case f.Degree:h=a.fromDegrees(h,k,e);break;case f.Radian:h=a.fromRadians(h);break;default:throw"style";}"-"===d.match[1]&&(h=h.negative());return h};d.RegexPatterns="^d ([+-])?(\\d{1,3}):( )?(\\d{1,2}):( )?(\\d{1,2}([\\.,]\\d+)?);^([+-])?(\\d{1,3}):( )?(\\d{1,2}):( )?(\\d{1,2}([\\.,]\\d+)?);^d ([+-])?(\\d{1,3})() (\\d{1,2})() (\\d{1,2}([\\.,]\\d+)?);^([+-])?(\\d{1,3})() (\\d{1,2})() (\\d{1,2}([\\.,]\\d+)?);^([+-])?(\\d{1,3})h( )?(\\d{1,2})m( )?(\\d{1,2}([\\.,]\\d+)?)[s]?;^([+-])?(\\d{1,3})d( )?(\\d{1,2})m( )?(\\d{1,2}([\\.,]\\d+)?)[s]?;^([+-])?(\\d{1,3})[\u00b0*]( )?(\\d{1,2})'( )?(\\d{1,2}([\\.,]\\d+)?)[\"]?;^([a-zA-Z])(\\d{2})()(\\d{2})()(\\d{2}([\\.,]\\d+)?);^([+-])?(\\d{2})()(\\d{2}[\\.,]\\d+);^([+-])?(\\d{2})()(\\d{2})()(\\d{2}([\\.,]\\d+)?);^[d][ ]([+-])?(\\d{1,3}([\\.\\,]\\d+)?);^([+-])?(\\d{1,3}([\\.,]\\d+)?)".split(";");
d.RegexPatternStyleMap={0:f.Degree,1:f.Degree,2:f.Degree,3:f.Degree,4:f.Hour,5:f.Degree,6:f.Degree,7:f.Hour,8:f.Degree,9:f.Degree,10:f.Degree,11:f.Radian};return d}();l.AngleParser=e;var a=function(){function d(a){this._dms=a*d.DegreeMillisecondsInDegree}Object.defineProperty(d.prototype,"hours",{get:function(){return this._dms/(d.DegreeMillisecondsInMillisecond*d.DegreeMillisecondsInDegree)},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"hour",{get:function(){return 0|this.hours},
...
d.prototype.__normalizePeriodic=function(a){return d.fromDegrees(this.__normalizeInternal(a))};d.prototype.__normalizeInternal=function(a){var d=this.degrees;a=(d-a)/360;0>a&&--a;return d-360*(0|a)};d.fromDegrees=function(a,e,f,h){a=(a||0)+(e||0)/60+(f||0)/3600+(h||0)/36E5;360<=Math.abs(a)&&(e=Math.floor(a),a-=e,a=e%360+a);return new d(a)};d.fromHours=function(a,e,f,h){a=(a||0)+(e||0)/60+(f||0)/3600+(h||0)/36E5;24<=Math.abs(a)&&(e=Math.floor(a),a-=e,a=e%24+a);return new d(a*d.DegreeMillisecondsInMillisecond)};
d.fromRadians=function(a){return d.fromDegrees(180*(a||0)/Math.PI)};d.parse=function(a,d){return e.parse(a,e.RegexPatternStyleMap,d)};d.absPad=function(a,d){d=d||0;var e=(10>a&&-10<a?"0":"")+(0<d?Math.abs(a).toFixed(d+1):Math.abs(a).toFixed(d));0<d&&(e=e.substr(0,d+3));return e};d.DegreeMillisecondsInDegree=36E5;d.DegreeMillisecondsInDegreeMinute=6E4;d.DegreeMillisecondsInDegreeSecond=1E3;d.DegreeMillisecondsInMillisecond=15;return d}();l.Angle=a},{}],2:[function(k,n,l){var f=k("../angle");k=function(){function h(e,
a){this.latitude=e;this.longitude=a}Object.defineProperty(h.prototype,"latitude",{get:function(){return this._lat},set:function(e){this._lat=e.normalize(-90,f.AngleNormalization.Reflective)},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"longitude",{get:function(){return this._lon},set:function(e){this._lon=e.normalize(-180)},enumerable:!0,configurable:!0});h.prototype.toFormattedString=function(e){e=e||{};null==e.digits&&(e.digits=1);return this.latitude.toFormattedString({format:"D",
digits:e.digits})+" "+this.longitude.toFormattedString({format:"D",digits:e.digits})};h.parse=function(e,a,d){a=f.AngleParser.match(e,h.RegexPatternStyleMap,a);if(!a.match)throw"s";var k=f.AngleParser.matchToAngle(a);e=e.substr(e.indexOf(a.match[0])+a.match[0].length);a=f.AngleParser.match(e,h.RegexPatternStyleMap,d);if(!a.match)throw"s";d=f.AngleParser.matchToAngle(a);e.substr(e.indexOf(a.match[0])+a.match[0].length).trim();return new h(k,d)};h.RegexPatternStyleMap={7:f.AngleStyle.Degree,11:f.AngleStyle.Degree};
return h}();l.EclipticCoordinates=k},{"../angle":1}],3:[function(k,n,l){var f=k("../angle"),h=k("../core/meeusEngine");k=function(){function e(a,d){this.rightAscension=a;this.declination=d}Object.defineProperty(e.prototype,"rightAscension",{get:function(){return this._ra},set:function(a){this._ra=a.normalize()},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"declination",{get:function(){return this._dec},set:function(a){this._dec=a.normalize(-90,f.AngleNormalization.Reflective)},
...
k.match[0].length);k=f.AngleParser.match(a,e.DecPatternStyleMap,h);if(!k.match)throw"s";a=f.AngleParser.matchToAngle(k);return new e(d,a)};e.RaPatternStyleMap={1:f.AngleStyle.Hour,3:f.AngleStyle.Hour,8:f.AngleStyle.Hour,9:f.AngleStyle.Hour,11:f.AngleStyle.Hour};e.DecPatternStyleMap={7:f.AngleStyle.Degree,11:f.AngleStyle.Degree};return e}();l.EquatorialCoordinates=k},{"../angle":1,"../core/meeusEngine":6}],4:[function(k,n,l){var f=k("../angle"),h=k("../core/meeusEngine");k=function(){function e(a,
d,e){this.latitude=a;this.longitude=d;this._alt=e||0}Object.defineProperty(e.prototype,"latitude",{get:function(){return this._lat},set:function(a){this._lat=a.normalize(-90,f.AngleNormalization.Reflective)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"longitude",{get:function(){return this._lon},set:function(a){this._lon=a.normalize(-180)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"altitude",{get:function(){return this._alt},enumerable:!0,configurable:!0});
e.prototype.sunrise=function(a,d){return h.MeeusEngine.getSunriseAt(this,a,d)};e.prototype.sunset=function(a,d){return h.MeeusEngine.getSunsetAt(this,a,d)};e.prototype.toFormattedString=function(a){a=a||{};null==a.digits&&(a.digits=1);return this.latitude.toFormattedString({format:"D",digits:a.digits})+" "+this.longitude.toFormattedString({format:"D",digits:a.digits})+" "+this.altitude};e.parse=function(a,d,h){var k=f.AngleParser.match(a,e.RegexPatternStyleMap,d);if(!k.match)throw"s";d=f.AngleParser.matchToAngle(k);
a=a.substr(a.indexOf(k.match[0])+k.match[0].length);k=f.AngleParser.match(a,e.RegexPatternStyleMap,h);if(!k.match)throw"s";h=f.AngleParser.matchToAngle(k);a=a.substr(a.indexOf(k.match[0])+k.match[0].length).trim();a=parseFloat(a);isNaN(a)&&(a=0);return new e(d,h,a)};e.RegexPatternStyleMap={7:f.AngleStyle.Degree,11:f.AngleStyle.Degree};return e}();l.GeographicCoordinates=k},{"../angle":1,"../core/meeusEngine":6}],5:[function(k,n,l){var f=k("../angle"),h=k("../core/meeusEngine");k=function(){function e(a,
...
g,a,d,e){g=g||b.calc_Earth_OrbitEccentricity(c);a=a||b.calc_Sun_MeanAnomaly(c);d=d||b.calc_Sun_EqOfCenter(c,a);e=e||b.calc_Sun_TrueAnomaly(c,a,d);return.99972/(1+g*b.dcos(e))};b.calc_Sun_MeanLongitude=function(c){return b.normalize(280.46646+c*(36000.76983+3.032E-4*c))};b.calc_Sun_MeanAnomaly=function(c,g,a){g=g||c*c;return b.normalize(357.52772+35999.05034*c-1.603E-4*g-(a||c*g)/3E5)};b.calc_Sun_EqOfCenter=function(c,g){var a=g||b.calc_Sun_MeanAnomaly(c),a=b.D2R*a;return Math.sin(a)*(1.914602-c*(.004817+
...
function(c,g,a,d,e){g*=2;var f=6.289*b.dsin(c)+1.274*b.dsin(g-c)+.6583*b.dsin(g),f=f+.2136*b.dsin(2*c)-.1851*b.dsin(e)-.1143*b.dsin(2*d),f=f+.0588*b.dsin(g-2*c),f=f+.0572*b.dsin(g-e-c)+.0533*b.dsin(g+c);return f+a};b.calc_Moon_HeliocentricLatitude=function(c,g){return c*g};b.calc_Moon_HeliocentricLongitude=function(c,g,a,d){return b.normalize(c+180+180/Math.PI*g*b.dcos(a)*b.dsin(c-d))};b.calc_Moon_ArgumentOfLatitude=function(c,g,a){g=g||c*c;return b.normalize(93.27191+483202.017538*c-.0036825*g+(a||
...
g:450-g;return f.Angle.fromDegrees(90<c&&270>c?180-c:90>c?0-c:360-c)};b.calc_Moon_IlluminatedDiscFraction=function(c){var g=c.centuriesSinceJ2000,a=g*g,d=g*a;c=b.calc_Earth_OrbitEccentricity(g);var e=b.calc_Sun_MeanAnomaly(g,a,d),f=b.calc_Sun_EqOfCenter(g,e),h=b.calc_Sun_TrueAnomaly(g,e,f);c=b.calc_Sun_Earth_Distance(g,c,e,f,h);var h=b.calc_Sun_LongitudeOfAscendingNode(g,a,d),k=b.calc_Sun_MeanLongitude(g),f=b.calc_Sun_TrueLong(g,k,f),k=b.calc_Sun_ApparentLong(g,f,h),l=b.calc_Moon_MeanAnomaly(g,a,
d),p=b.calc_Moon_MeanElongation(g,a,d),f=b.calc_Moon_Earth_Distance(l,p),f=b.calc_Moon_Sun_DistanceRatio(f,c),a=b.calc_Moon_ArgumentOfLatitude(g,a,d),d=b.calc_Moon_GeocentricLatitude(a,l,p),g=b.calc_Moon_MeanLongitude(g),e=b.calc_Moon_GeocentricLongitude(l,p,g,a,e),g=b.calc_Moon_HeliocentricLatitude(f,d),l=b.calc_Moon_HeliocentricLongitude(k,f,g,e),l=b.normalize(l-h),p=b.dcos(l)*b.dcos(g),h=b.dsin(l)*b.dcos(g)*b.dcos(1.54242)-b.dsin(g)*b.dsin(1.54242);b.normalize(b.datan2(h,p)-a);b.dasin(-b.dsin(l)*
b.dcos(g)*b.dsin(1.54242)-b.dsin(g)*b.dcos(1.54242));k=b.dcos(d)*b.dcos(e-k);h=90-b.datan(k/Math.sqrt(1-k*k));h=c*b.dsin(h);c=b.datan2(h,f-c*k);return(1+b.dcos(c))/2};b.calc_Ecliptic_NutationInLongitude=function(c,g,b,a,d,e){var f=-(171996+174.2*c)*Math.sin(g)-(13187+1.6*c)*Math.sin(-2*b+2*a+2*g)-(2274+.2*c)*Math.sin(2*a+2*g)+(2062+.2*c)*Math.sin(2*g)+(1426-3.4*c)*Math.sin(d)+(712+.1*c)*Math.sin(e),f=f+((-517+1.2*c)*Math.sin(-2*b+d+2*a+2*g)-(386+.4*c)*Math.sin(2*a+g)-301*Math.sin(e+2*a+2*g)+(217-
...
a+2*e+f)+3*Math.cos(2*a+2*e-f)+3*Math.cos(a+2*e+2*d);g-=3*Math.cos(2*(a+e+h-d))-3*Math.cos(a+2*e+h-2*d)+3*Math.cos(a-2*h+2*d)+3*Math.cos(a+2*d)+3*Math.cos(a+2*e-f-2*d)+3*Math.cos(a-2*d)+3*Math.cos(a+2*e+2*h);return 1E-4/3600*g};b.toGasDegrees=function(c){c=c.daysSinceJ2000;var a=c/36525,e=a*a,d=e*a,f=b.calc_Moon_MeanElongation(a,e,d)*b.D2R,h=b.calc_Sun_MeanAnomaly(a,e,d)*b.D2R,k=b.calc_Moon_MeanAnomaly(a,e,d)*b.D2R,l=b.calc_Moon_ArgumentOfLatitude(a,e,d)*b.D2R,p=b.calc_Sun_LongitudeOfAscendingNode(a,
e,d)*b.D2R,n=b.calc_Ecliptic_NutationInLongitude(a,p,f,l,h,k),a=b.calc_Ecliptic_MeanObliquity(a,e,d)+b.calc_Ecliptic_MeanObliquityCorrection(a,e,d,p,f,l,h,k);c=280.46061837+360.98564736629*c+3.87933E-4*e-d/3871E4+n*Math.cos(a*b.D2R);return c=b.normalize(c)};b.correctForRefraction=function(c){c instanceof f.Angle&&(c=c.degrees);var a=1/Math.tan((c+7.31/(c+4.4))*b.D2R),a=a-.06*Math.sin((14.7*a/60+13)*b.D2R);return f.Angle.fromDegrees(c+a/60)};b.uncorrectRefraction=function(c){c instanceof f.Angle&&
...
function(h){return new f(this.days+h/86400)};f.prototype.addMilliseconds=function(h){return new f(this.days+h/864E5)};return f}();l.TtDate=k},{}],11:[function(k,n,l){var f=k("../core/meeusEngine");k=function(){function h(e){this._days=void 0===e?h.getJulianDays(new Date):e}Object.defineProperty(h.prototype,"days",{get:function(){return this._days},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"daysSinceJ2000",{get:function(){return this._days-2451545},enumerable:!0,configurable:!0});
Object.defineProperty(h.prototype,"centuriesSinceJ2000",{get:function(){return this.daysSinceJ2000/36525},enumerable:!0,configurable:!0});Object.defineProperty(h,"J2000",{get:function(){return new h(2451545)},enumerable:!0,configurable:!0});Object.defineProperty(h,"B1950",{get:function(){return new h(2433282.4229166666)},enumerable:!0,configurable:!0});h.prototype.addDays=function(e){return new h(this.days+e)};h.prototype.addHours=function(e){return new h(this.days+e/24)};h.prototype.addMinutes=function(e){return new h(this.days+
