...
k.match[0].length);k=f.AngleParser.match(a,e.DecPatternStyleMap,h);if(!k.match)throw"s";a=f.AngleParser.matchToAngle(k);return new e(d,a)};e.RaPatternStyleMap={1:f.AngleStyle.Hour,3:f.AngleStyle.Hour,8:f.AngleStyle.Hour,11:f.AngleStyle.Hour};e.DecPatternStyleMap={7:f.AngleStyle.Degree,11:f.AngleStyle.Degree};return e}();l.EquatorialCoordinates=k},{"../angle":1,"../core/meeusEngine":6}],4:[function(k,n,l){var f=k("../angle"),h=k("../core/meeusEngine");k=function(){function e(a,d,e){this.latitude=a;
this.longitude=d;this._alt=e||0}Object.defineProperty(e.prototype,"latitude",{get:function(){return this._lat},set:function(a){this._lat=a.normalize(-90,f.AngleNormalization.Reflective)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"longitude",{get:function(){return this._lon},set:function(a){this._lon=a.normalize(-180)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"altitude",{get:function(){return this._alt},enumerable:!0,configurable:!0});e.prototype.sunrise=
