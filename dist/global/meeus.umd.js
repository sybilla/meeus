...
var hjddate_1 = require('../datetime/hjddate');
var ttdate_1 = require('../datetime/ttdate');
var siderealtimes_1 = require('../datetime/siderealtimes');
var taidate_1 = require('../datetime/taidate');
var geographicCoordinates_1 = require('../coordinateSystems/geographicCoordinates');
var equatorialCoordinates_1 = require('../coordinateSystems/equatorialCoordinates');
var horizontalCoordinates_1 = require('../coordinateSystems/horizontalCoordinates');
(function (Twilight) {
...
var MeeusEngine = (function () {
    ...
    //#region Math helpers 
    MeeusEngine.dsin = function (x) { return Math.sin(MeeusEngine.D2R * x); };
    MeeusEngine.dcos = function (x) { return Math.cos(MeeusEngine.D2R * x); };
    MeeusEngine.dtan = function (x) { return Math.tan(MeeusEngine.D2R * x); };
    MeeusEngine.dasin = function (x) { return MeeusEngine.R2D * Math.asin(x); };
    MeeusEngine.dacos = function (x) { return MeeusEngine.R2D * Math.acos(x); };
    MeeusEngine.datan = function (x) { return MeeusEngine.R2D * Math.atan(x); };
    ...
    MeeusEngine.normalize = function (x) { return x - (360.0 * Math.floor(x / 360.0)); };
    ...
    MeeusEngine.calc_SunriseOrSunset = function (isSunrise, jd, location, twilight) {
        var date = jd.toDate();
        var JD = new utcdate_1.UtcDate(utcdate_1.UtcDate.toUtcDays(date.getFullYear(), date.getMonth(), date.getDate())); //jd.days;
...
__export(require('./solarSystem/moon'));
__export(require('./solarSystem/earth'));
__export(require('./solarSystem/sun'));
__export(require('./datetime/hjddate'));
__export(require('./datetime/siderealtimes'));
